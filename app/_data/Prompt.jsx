...
export const LOGO_PROMPT = `
  Create a logo for {logoTitle}, which is a {logoDesc}.
  The logo should use the color palette {logoColor} and follow the design style {logoDesign}.
  Additional design ideas: {logoPrompt}.
`;